...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Developed and integrated a RAG-based conversational assistant using FastAPI, structuring a domain-specific knowledge base and MongoDB state management to deliver grounded recommendations.}
    \resumeItem{Designed a multi-layer LLM safety and retrieval workflow combining cosine similarity semantic filtering and rate-limit-aware caching with Google Gemini and Groq APIs to reduce redundant calls and optimize latency.}
