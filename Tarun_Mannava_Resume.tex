...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Contributed to a RAG-based nutrition chatbot for the MyFoodRx health platform, structuring a domain-specific knowledge base and retrieval workflows to deliver grounded recommendations.}
    \resumeItem{Designed a multi-layer LLM safety architecture combining query classification, cosine similarity semantic filtering, and rate-limit-aware caching with Google Gemini to optimize response quality.}
